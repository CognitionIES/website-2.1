...
import heroImage from "@/constants/images/projects/digitalization/hero-image-1.jpg";
        ...
        <div className="relative z-20 h-full flex flex-col justify-center space-y-6">
          ...
          >
            ...
            <Link
              ...
              className="hover:text-blue-300 transition-colors duration-300"
            >
              <span className="text-blue-200 font-medium">Digitalization</span>
            </Link>
          </motion.nav>
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl text-white font-extrabold tracking-tight leading-tight">
              Digitalization
            </h1>
            <motion.div
              className="absolute -bottom-2 left-1 w-28 h-1 bg-gradient-to-r from-[#99D5DF] to-transparent rounded-full"
              initial={{ width: 0 }}
              animate={isVisible ? { width: 112 } : {}}
