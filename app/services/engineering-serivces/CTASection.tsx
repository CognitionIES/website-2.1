  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Your engineering{" "}
          <em className="not-italic text-[#0098AF]">vision?</em>
        </h2>

        <p className="text-[15px] md:text-[16px] text-white/65 leading-relaxed max-w-2xl mx-auto mb-9">
          Partner with our expert engineering team to bring innovative solutions to life. From concept to completion, we deliver excellence that exceeds expectations.
        </p>
