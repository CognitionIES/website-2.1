...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="relative h-[480px] md:h-[520px] overflow-hidden">
      ...
      <Image
        src={heroImage}
        alt="Recruitment and Resourcing"
        fill
        className="object-cover"
        priority
      />

      {/* Colour overlays only */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
        ...
        >
          ...
          <FiChevronRight className="w-3 h-3 text-white/30" />
          <span className="text-[#0098AF]/90">Recruitment & Resourcing</span>
        </motion.nav>
        ...
        >
          Services · Recruitment & Resourcing
        </motion.p>
        ...
        >
          Connecting the right talent with the right opportunity — strategic, meaningful, and built to last.
        </motion.p>
      </div>
      ...
      {/*
        Bottom clip — next section is AboutSection: bg-white dark:bg-[#0a0a0f]
      */}
      <div
